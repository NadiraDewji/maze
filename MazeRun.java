...
public class MazeRun {
	...
	public static void main (String [] args) {
		...
		//create maze object
		Maze maze = new Maze(charMazeFromFile);	
	 ...
	 */
	public static void searchForWayOut (Maze maze, 
			SetOfSpaces listOfSquares)  {
		
		//set a random start position
		SquarePosition start = maze.generateStartPosition();
		
		//variables used in running of the algorithm
		SquarePosition current = null;
		ArrayList<SquarePosition> neighbors = null;
